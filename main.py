...
def main():
    ...
    st.set_page_config(page_title="김태형", page_icon="💕")  # 웹 페이지 제목과 아이콘 설정
    st.image('body.png')  # 상단에 이미지를 표시
    st.title("_:green[우리 몸의 구조와 기능]_ 🏫")  # 제목 표시 (우리 몸의 구조와 기능)
    st.header("😶주의! 이 챗봇은 참고용으로 사용하세요!", divider='blue')  # 주의사항 표시
